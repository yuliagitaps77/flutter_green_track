        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              child: AnimatedBuilder(
                animation:
                    Listenable.merge([_mainAnimation, _leafFloatingAnimation]),
                builder: (context, child) {
                  return Opacity(
                    ...
                    child: Transform.translate(
                      offset: Offset(
                        5 *
                            math.sin(
                                _leafFloatingAnimation.value * 2 * math.pi),
                        40 * (1 - _mainAnimation.value) +
                            5 *
                                math.cos(
                                    _leafFloatingAnimation.value * 2 * math.pi),
                      ),
            ...
            Positioned(
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  return Opacity(
                    opacity: _mainAnimation.value * 0.7,
                    child: Transform.translate(
                      offset: Offset(
                        20 * (1 - _mainAnimation.value) +
                            7 *
                                math.sin(
                                    _leafFloatingAnimation.value * 2 * math.pi +
                                        1.5),
